...
import '../widget/specialoffer.dart';
  ...
  return ListView.builder( itemCount: newz.savednews.length,
  shrinkWrap: true, physics:  NeverScrollableScrollPhysics(),
  itemBuilder: (BuildContext, index){
  return  GestureDetector(
  onTap:(){Get.toNamed(Routes.getfavFullnewspage(index));},
  child: NewsCard(backgroundcolor: const Color(0xff131315),
  ...
  children: [
  SizedBox(height: Dimensions.height10,),
  BigText('${newz.savednews[index].title}',color: Colors.grey.shade200,size: 18,),
  SizedBox(height: Dimensions.height10,),
  SmallTxt('${newz.savednews[index].description}',color: Colors.grey.shade400,size: 14,),
  SmallTxt('${newz.savednews[index].pubDate}',color: Colors.yellow.shade400,size: 14,)
  ],),
  )
  ]
  ),
